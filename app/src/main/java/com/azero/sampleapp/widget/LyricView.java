...
public class LyricView extends RelativeLayout implements View.OnTouchListener {
    ...
    protected void onFinishInflate() {
        ...
        mTextView.setTextSize(24.0f); // 设置TextView字体大小
    ...
    public boolean onTouch(View view, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (upTimeStamp - downTimeStamp < 500 && lyricViewOnClickListener != null) {
    ...
    public void scrollRequestFocus() {
        boolean flag = mScrollView.requestFocus();
        Log.d("SoundAI.LyricView", "scrollRequestFocus: flag = " + flag);
    }

    public void startAnimator() {
        handler.sendEmptyMessage(MSG_USER_TOUCH);
    }
